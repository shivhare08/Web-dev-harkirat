    ...
    return (
        <>
            <div className="w-full min-h-screen bg-purple-900 pb-10">
                <p className="text-2xl text-center font-semibold pt-11 text-white">My Youtube contents</p>
                ...
                <div className="flex justify-center">
                    <div className="flex gap-2 flex-wrap justify-center">
                        {contents.map(({ type, link, title }) =>(type==="youtube") && <Card type={type} link={link} title={title} />)}
                    </div>
                </div>
            </div>
        </>
